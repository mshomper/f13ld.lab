...
'  let d11 = s11 - pmean;',
'  let d22 = s22 - pmean;',
'  let snorm = sqrt(d00*d00 + d11*d11 + d22*d22 + 2.0*(s23*s23 + s13*s13 + s12*s12));',
'  let fTrial = snorm - SQRT23 * flow_sigY(P, al);',
'',
'  if (fTrial <= 0.0 || snorm < 1e-30) {',
...
'      let r  = snorm - 2.0*P.mu_s*dgamma - SQRT23 * flow_sigY(P, aT);',
